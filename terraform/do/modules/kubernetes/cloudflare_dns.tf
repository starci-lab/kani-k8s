...
locals {
  argo_cd_domain_name                = "${var.argo_cd_prefix}.${var.prefix_domain_name != "none" ? "${var.prefix_domain_name}." : ""}${var.domain_name}"
  prometheus_domain_name              = "${var.prometheus_prefix}.${var.prefix_domain_name != "none" ? "${var.prefix_domain_name}." : ""}${var.domain_name}"
  prometheus_alertmanager_domain_name = "${var.prometheus_alertmanager_prefix}.${var.prefix_domain_name != "none" ? "${var.prefix_domain_name}." : ""}${var.domain_name}"
  ...
  loki_domain_name                    = "${var.loki_prefix}.${var.prefix_domain_name != "none" ? "${var.prefix_domain_name}." : ""}${var.domain_name}"
}
