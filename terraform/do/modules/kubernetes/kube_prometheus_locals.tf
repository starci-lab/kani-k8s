// =========================
// kube-prometheus inputs
// =========================
// Preset mappings for kube-prometheus components.
...
// =========================
// kube-prometheus computed values
// =========================
// Resource requests and limits for kube-prometheus components.
